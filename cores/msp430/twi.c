...
#if defined(USCI_B0_BASE) || defined(USCI_B1_BASE) || defined(EUSCI_B0_BASE) || defined(EUSCI_B1_BASE)

#if defined(__MSP430_HAS_USCI_B0__)
#define UCB0_BASE USCI_B0_BASE
#elif defined(__MSP430_HAS_EUSCI_B0__)
#define UCB0_BASE EUSCI_B0_BASE
#endif
#if defined(__MSP430_HAS_USCI_B1__)
#define UCB1_BASE USCI_B1_BASE
#elif defined(__MSP430_HAS_EUSCI_B1__)
#define UCB1_BASE EUSCI_B1_BASE
#endif
...
#define UCBxIRRCTL    (*((volatile uint8_t  *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0IRRCTL) - UCB0_BASE))))
...
//#define UCBxIE        (*((volatile uint8_t  *)((uint16_t)(I2C_baseAddress + &UCB0ICTL   - UCB0_BASE))))
//#define UCBxIFG       (*((volatile uint8_t  *)((uint16_t)(I2C_baseAddress + &UCB0ICTL+1 - UCB0_BASE))))
//#else
...
//#define UCBxMCTL      (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + &UCB0MCTL   - UCB0_BASE)))) 
#define UCBxSTAT      (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0STAT)   - UCB0_BASE)))) 
#define UCBxRXBUF     (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0RXBUF)  - UCB0_BASE)))) 
#define UCBxTXBUF     (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0TXBUF)  - UCB0_BASE)))) 
//#define UCBxICTL      (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + &UCB0ICTL   - UCB0_BASE)))) 
#define UCBxI2COA     (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0I2COA)  - UCB0_BASE)))) 
#define UCBxI2CSA     (*((volatile uint8_t *)((uint16_t)(I2C_baseAddress + ((uint16_t)&UCB0I2CSA)  - UCB0_BASE)))) 
